...
// Only publish articles whose claims match the current product surface.
export const POSTS: BlogPost[] = [
  ...
  {
    slug: "choosing-restaurant-pos-hardware",
    title: "Choosing the right POS hardware for your restaurant",
    description:
      "A practical guide to starting with Android devices and adding printers only when the workflow needs them.",
    author: "KhanaBook Team",
